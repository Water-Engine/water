...
template <class T, class A> XSIMD_INLINE batch<T, A> abs(batch<T, A> const& self) noexcept;
template <class T, class A>
XSIMD_INLINE batch<T, A> abs(batch<std::complex<T>, A> const& self) noexcept;
template <class T, class A> XSIMD_INLINE bool any(batch_bool<T, A> const& self) noexcept;
template <class T, class A>
...
template <class T, class A> XSIMD_INLINE batch<T, A> bitofsign(batch<T, A> const& self) noexcept;
template <class T_out, class T_in, class A>
XSIMD_INLINE batch<T_out, A> bitwise_cast(batch<T_in, A> const& self) noexcept;
template <class T, class A> XSIMD_INLINE batch<T, A> cos(batch<T, A> const& self) noexcept;
template <class T, class A> XSIMD_INLINE batch<T, A> cosh(batch<T, A> const& self) noexcept;
template <class T, class A> XSIMD_INLINE batch<T, A> exp(batch<T, A> const& self) noexcept;
template <class T, class A>
XSIMD_INLINE batch<T, A> fma(batch<T, A> const& x, batch<T, A> const& y,
                             batch<T, A> const& z) noexcept;
template <class T, class A>
XSIMD_INLINE batch<T, A> fms(batch<T, A> const& x, batch<T, A> const& y,
                             batch<T, A> const& z) noexcept;
template <class T, class A>
XSIMD_INLINE batch<T, A> fmas(batch<T, A> const& x, batch<T, A> const& y,
                              batch<T, A> const& z) noexcept;
template <class T, class A>
...
template <class T, class A> XSIMD_INLINE batch<T, A> hypot(const batch<T, A>& self) noexcept;
template <class T, class A> XSIMD_INLINE batch_bool<T, A> is_even(batch<T, A> const& self) noexcept;
template <class T, class A>
XSIMD_INLINE batch_bool<T, A> is_flint(batch<T, A> const& self) noexcept;
template <class T, class A> XSIMD_INLINE batch_bool<T, A> is_odd(batch<T, A> const& self) noexcept;
template <class T, class A>
...
template <class T, class A> XSIMD_INLINE batch<T, A> log(batch<T, A> const& self) noexcept;
template <class T, class A> XSIMD_INLINE batch<T, A> nearbyint(batch<T, A> const& self) noexcept;
template <class T, class A>
XSIMD_INLINE batch<as_integer_t<T>, A> nearbyint_as_int(const batch<T, A>& x) noexcept;
template <class T, class A> XSIMD_INLINE T reduce_add(batch<T, A> const&) noexcept;
template <class T, class A> XSIMD_INLINE T reduce_mul(batch<T, A> const&) noexcept;
template <class T, class A>
XSIMD_INLINE batch<T, A> select(batch_bool<T, A> const&, batch<T, A> const&,
                                batch<T, A> const&) noexcept;
template <class T, class A>
XSIMD_INLINE batch<std::complex<T>, A> select(batch_bool<T, A> const&,
                                              batch<std::complex<T>, A> const&,
                                              batch<std::complex<T>, A> const&) noexcept;
template <class T, class A> XSIMD_INLINE batch<T, A> sign(batch<T, A> const& self) noexcept;
template <class T, class A> XSIMD_INLINE batch<T, A> signnz(batch<T, A> const& self) noexcept;
template <class T, class A> XSIMD_INLINE batch<T, A> sin(batch<T, A> const& self) noexcept;
template <class T, class A> XSIMD_INLINE batch<T, A> sinh(batch<T, A> const& self) noexcept;
template <class T, class A>
XSIMD_INLINE std::pair<batch<T, A>, batch<T, A>> sincos(batch<T, A> const& self) noexcept;
template <class T, class A> XSIMD_INLINE batch<T, A> sqrt(batch<T, A> const& self) noexcept;
...
template <class T, class A> XSIMD_INLINE batch<T, A> tan(batch<T, A> const& self) noexcept;
template <class T, class A>
...
template <class T, class A> XSIMD_INLINE batch<T, A> trunc(batch<T, A> const& self) noexcept;

namespace kernel {

namespace detail {
template <class F, class A, class T, class... Batches>
XSIMD_INLINE batch<T, A> apply(F&& func, batch<T, A> const& self,
...
namespace detail {
template <class A>
XSIMD_INLINE batch<uint8_t, A> fast_cast(batch<int8_t, A> const& self, batch<uint8_t, A> const&,
                                         requires_arch<common>) noexcept {
    return bitwise_cast<uint8_t>(self);
}
template <class A>
XSIMD_INLINE batch<uint16_t, A> fast_cast(batch<int16_t, A> const& self, batch<uint16_t, A> const&,
                                          requires_arch<common>) noexcept {
    return bitwise_cast<uint16_t>(self);
}
template <class A>
XSIMD_INLINE batch<uint32_t, A> fast_cast(batch<int32_t, A> const& self, batch<uint32_t, A> const&,
                                          requires_arch<common>) noexcept {
    return bitwise_cast<uint32_t>(self);
}
template <class A>
XSIMD_INLINE batch<uint64_t, A> fast_cast(batch<int64_t, A> const& self, batch<uint64_t, A> const&,
                                          requires_arch<common>) noexcept {
    return bitwise_cast<uint64_t>(self);
}
template <class A>
XSIMD_INLINE batch<int8_t, A> fast_cast(batch<uint8_t, A> const& self, batch<int8_t, A> const&,
                                        requires_arch<common>) noexcept {
    return bitwise_cast<int8_t>(self);
}
template <class A>
XSIMD_INLINE batch<int16_t, A> fast_cast(batch<uint16_t, A> const& self, batch<int16_t, A> const&,
                                         requires_arch<common>) noexcept {
    return bitwise_cast<int16_t>(self);
}
template <class A>
XSIMD_INLINE batch<int32_t, A> fast_cast(batch<uint32_t, A> const& self, batch<int32_t, A> const&,
                                         requires_arch<common>) noexcept {
    return bitwise_cast<int32_t>(self);
}
template <class A>
XSIMD_INLINE batch<int64_t, A> fast_cast(batch<uint64_t, A> const& self, batch<int64_t, A> const&,
                                         requires_arch<common>) noexcept {
...
template <class A, class _ = decltype(fast_cast(std::declval<batch<int32_t, A> const&>(),
                                                std::declval<batch<float, A> const&>(), A{}))>
XSIMD_INLINE batch<float, A> fast_cast(batch<uint32_t, A> const& v, batch<float, A> const&,
                                       requires_arch<common>) noexcept {
    // see
    ...
    auto v_lo =
        batch_cast<int32_t>(v & msk_lo);      /* extract the 16 lowest significant bits of self      */
    ...
    return v_hi_flt + v_lo_flt; /* Rounding may occur here, mul and add may fuse to fma for haswell
                                   and newer   */
}

// Provide a common float -> uint32_t cast only if we have a
// non-common float -> int32_t fast_cast
template <class A, class _ = decltype(fast_cast(std::declval<batch<float, A> const&>(),
                                                std::declval<batch<int32_t, A> const&>(), A{}))>
XSIMD_INLINE batch<uint32_t, A> fast_cast(batch<float, A> const& v, batch<uint32_t, A> const&,
                                          requires_arch<common>) noexcept {
    auto is_large = v >= batch<float, A>(1u << 31);
    auto small_v = bitwise_cast<float>(batch_cast<int32_t>(v));
    auto large_v = bitwise_cast<float>(batch_cast<int32_t>(v - batch<float, A>(1u << 31)) ^
...
template <class A, class From, class To, class = void> struct conversion_type_impl {
...
struct conversion_type_impl<
    ...
    void_t<decltype(fast_cast(std::declval<const batch<From, A>&>(),
                              std::declval<const batch<To, A>&>(), std::declval<const A&>()))>> {
 ...
 * ====================================================
 */
template <class B, uint64_t c> XSIMD_INLINE B coef() noexcept {
    using value_type = typename B::value_type;
    return B(bit_cast<value_type>(as_unsigned_integer_t<value_type>(c)));
}
template <class B> XSIMD_INLINE B horner(const B&) noexcept {
    return B(typename B::value_type(0.));
}

template <class B, uint64_t c0> XSIMD_INLINE B horner(const B&) noexcept { return coef<B, c0>(); }
 ...
 * ====================================================
 */
template <class B> XSIMD_INLINE B horner1(const B&) noexcept { return B(1.); }

template <class B, uint64_t c0> XSIMD_INLINE B horner1(const B& x) noexcept {
