...
template <class A, class T>
XSIMD_INLINE batch<T, A> real(batch<std::complex<T>, A> const& self,
...
template <class A, class T>
XSIMD_INLINE batch<T, A> imag(batch<std::complex<T>, A> const& self,
                              requires_arch<common>) noexcept {
    return self.imag();
}
...
// arg
template <class A, class T>
XSIMD_INLINE real_batch_type_t<batch<T, A>> arg(batch<T, A> const& self,
                                                requires_arch<common>) noexcept {
...
// conj
template <class A, class T>
XSIMD_INLINE complex_batch_type_t<batch<T, A>> conj(batch<T, A> const& self,
                                                    requires_arch<common>) noexcept {
...
// norm
template <class A, class T>
XSIMD_INLINE real_batch_type_t<batch<T, A>> norm(batch<T, A> const& self,
                                                 requires_arch<common>) noexcept {
...
// proj
template <class A, class T>
XSIMD_INLINE complex_batch_type_t<batch<T, A>> proj(batch<T, A> const& self,
                                                    requires_arch<common>) noexcept {
...
template <class A, class T>
XSIMD_INLINE batch_bool<T, A> isnan(batch<std::complex<T>, A> const& self,
                                    requires_arch<common>) noexcept {
    return batch_bool<T, A>(isnan(self.real()) || isnan(self.imag()));
}

template <class A, class T>
XSIMD_INLINE batch_bool<T, A> isinf(batch<std::complex<T>, A> const& self,
                                    requires_arch<common>) noexcept {
    return batch_bool<T, A>(isinf(self.real()) || isinf(self.imag()));
}

template <class A, class T>
XSIMD_INLINE batch_bool<T, A> isfinite(batch<std::complex<T>, A> const& self,
                                       requires_arch<common>) noexcept {
