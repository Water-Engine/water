...
#define XSIMD_LITTLE_ENDIAN
#elif defined(i386) || defined(i486) || defined(intel) || defined(x86) || defined(i86pc) ||        \
...
#define GET_HIGH_WORD(i, d)                                                                        \
    do {                                                                                           \
        double f = (d);                                                                            \
        std::memcpy(&(i), reinterpret_cast<char*>(&f) + HIGH_WORD_IDX, sizeof(std::uint32_t));     \
    }                                                                                              \
    ONCE0                                                                                          \
    /**/
...
#define GET_LOW_WORD(i, d)                                                                         \
    do {                                                                                           \
        double f = (d);                                                                            \
        std::memcpy(&(i), reinterpret_cast<char*>(&f) + LOW_WORD_IDX, sizeof(std::uint32_t));      \
    }                                                                                              \
    ONCE0                                                                                          \
    /**/
...
#define SET_HIGH_WORD(d, v)                                                                        \
    do {                                                                                           \
        ...
        std::memcpy(reinterpret_cast<char*>(&f) + HIGH_WORD_IDX, &value, sizeof(std::uint32_t));   \
        (d) = f;                                                                                   \
    }                                                                                              \
    ONCE0                                                                                          \
    /**/
...
#define SET_LOW_WORD(d, v)                                                                         \
    do {                                                                                           \
        double f = (d);                                                                            \
        std::uint32_t value = (v);                                                                 \
        std::memcpy(reinterpret_cast<char*>(&f) + LOW_WORD_IDX, &value, sizeof(std::uint32_t));    \
        (d) = f;                                                                                   \
    }                                                                                              \
    ONCE0                                                                                          \
    /**/
...
XSIMD_INLINE int32_t __kernel_rem_pio2(double* x, double* y, int32_t e0, int32_t nx, int32_t prec,
                                       const int32_t* ipio2) noexcept {
