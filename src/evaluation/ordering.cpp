...
void MoveOrderer::order_moves(Ref<Board> board, const Move& hash_move, Movelist& moves,
    ...
    //     bool is_capture = piece_to_capture.type();

    //     Bitboard opponent_non_pawn_attacks =
    //     board->non_pawn_attack_rays(board->opponent_color()); Bitboard opponent_pawn_attacks =
    //     board->pawn_attack_rays(board->opponent_color()); Bitboard all_opponent_attacks =
    //     opponent_non_pawn_attacks | opponent_pawn_attacks;
    ...
    //         int score_to =
    //             pst.get_value_tapered_unchecked(piece_to_move, target_square,
    //             endgame_transition);
