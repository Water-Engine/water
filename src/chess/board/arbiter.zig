...
test "Halfmove draws" {
    ...
    try expectEqual(result4.result, .lose);
    ...
    try expectEqual(result4_pre_ml.result, .lose);
...
test "Game over" {
    ...
    try expectEqual(result2.result, .lose);
    ...
    try expectEqual(result2_pre_ml.result, .lose);
